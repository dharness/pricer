/*
    Transitions is a series of functions for navigating the views of the app.
    To change views, simply replace the content of #theBody with html from
    your own template, located in the views folder
*/
